	...
	final class GoogleChartTest extends TestCase
	{
		...
		public function testTwoAxisLineChart()
		{
			$views =
				...
				setData([195, 191, 197, 183, 199, 195]);
		...
		public function testGridedLineChart()
		{
			...
			$days = [02.03, 09.03, 16.03, 23.03, 30.03, 06.04];
